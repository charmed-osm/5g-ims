...
class PcscfCharm(CharmBase):
    ...
    def __init__(self, *args) -> NoReturn:
        ...
        self.framework.observe(
            self.on.pcscfip_relation_joined, self._publish_pcscf_info
        )
    ...
    def _publish_pcscf_info(self, event: EventBase) -> NoReturn:
        logger.info("PCSCF Provides")
        logger.info("*******************1********************")
        if self.unit.is_leader():
            logger.info("PCSCF IP")
    ...
    def configure_pod(self, event: EventBase) -> NoReturn:
        ...
        try:
            logger.info("Printing in pcscf charm")
            logger.info(self.model.name)
